...
CREATE INDEX ind_fk_sec_device_user_id ON db.sec_device (user_id) tablespace musicdb_index;
...
CREATE INDEX ind_fk_cnt_music_ratio_device_id ON db.cnt_music_ratio (device_id) tablespace musicdb_index;
...
CREATE INDEX ind_fk_cnt_music_history_device_id ON db.cnt_music_history (device_id) tablespace musicdb_index;
