...
ALTER TABLE db.sec_device ADD CONSTRAINT sec_device_uid_FK FOREIGN KEY (user_id) REFERENCES db.sec_user(id);
...
ALTER TABLE db.cnt_music_ratio ADD CONSTRAINT cnt_music_ratio_did_FK FOREIGN KEY (device_id) REFERENCES db.sec_device(device_id) ON DELETE CASCADE;
...
ALTER TABLE db.cnt_music_history ADD CONSTRAINT cnt_music_history_did_FK FOREIGN KEY (device_id) REFERENCES db.sec_device(device_id) ON DELETE CASCADE;
